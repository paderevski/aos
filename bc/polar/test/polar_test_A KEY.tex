...
\section*{KEY KEY A Matching -- 1 pt each}
\begin{center}
\begin{tabular}{|c|c|c|}
\hline
A \begin{asy}
...
an $xy$ plane below. Its shadow on the $x y$-plane has position $(x(t), y(t))$ at
 time $t \geq 0$ with
...
$a(4) = \langle v_x'(4),v_y'(4) \rangle = \langle 0.433,-11.872 \rangle$

\item Find the $y$-coordinate of the position of the shadow at time $t=0$.

$s(0) = s(4) + \displaystyle \int_4^0 v(t) \; dt = \langle -7.238, 0.601 \rangle$

\item On the interval $0 \leq t \leq 4$, at what time does the
 speed of the shadow first reach 3.5 ?

Solve $\sqrt{v_x^2(t)+v_y^2(t)}-3.5 = 0$ and find $t = 2.226$

\item Find the total distance traveled by the shadow over the time
interval $0 \leq t \leq 4$.

$\displaystyle \int_0^4 \sqrt{v_x^2(t)+v_y^2(t)} \; dt = 11.129$
\end{enumerate}
