...
\section*{KEY KEY C Matching -- 1 pt each question}
\begin{center}
\begin{tabular}{|c|c|c|}
\hline
A \begin{asy}
...
$a(4) = \langle v_x'(4),v_y'(4) \rangle = \langle 0.433013, -11.8723 \rangle$

\item Find the $y$-coordinate of the position of the shadow at time $t=1$.

$s(1) = s(4) + \displaystyle \int_4^1 v(t) \; dt = \langle -6.0829, 4.52647 \rangle$
...
Solve $\sqrt{v_x^2(t)+v_y^2(t)}-3.2 = 0$ and find $t = 0.441822$
 ...
 \item Find the total distance traveled by the shadow over
 the time interval $0 \leq t \leq 5$.

$\displaystyle \int_0^5 \sqrt{v_x^2(t)+v_y^2(t)} \; dt = 17.4168$
