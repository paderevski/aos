...
\begin{oneparchoices}
	\choice \sageplot[width=1.5in,height=1.5in]{hyperbola(1,2,1,1)}
	\choice \sageplot[width=1.5in,height=1.5in]{hyperbola(2,1,1,1)}
	\\
	\choice \sageplot[width=1.5in,height=1.5in]{hyperbola(1,1,-2,1)}
	\choice \sageplot[width=1.5in,height=1.5in]{hyperbola(1,1,-2,2)}
